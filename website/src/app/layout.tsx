...
export const metadata: Metadata = {
  ...
  description:
    "India's most trusted debt settlement partner. Settle credit card dues, personal loans & EMI at up to 70% less. Expert legal team. RBI compliant. Free consultation. Call +91 96014 43663.",
  keywords: [
    ...
    "loan waiver India",
    "debt free India",
    "anti harassment recovery agents",
    "RBI complaint debt",
  ...
  openGraph: {
    ...
    description:
      "Settle your credit card dues & personal loans at up to 70% less. India's most trusted debt settlement partner. Expert legal team. Free consultation.",
    images: [
      {
        url: "/og-image.webp",
        width: 1200,
  ...
  twitter: {
    ...
    description:
      "Settle credit card dues & personal loans at up to 70% less. RBI compliant. Free consultation.",
  ...
  "@graph": [
    {
      ...
      name: "Due Dost",
      description:
        "India's most trusted debt settlement partner. Settle credit card dues, personal loans & EMI at up to 70% less.",
      potentialAction: {
        "@type": "SearchAction",
        target: {
          "@type": "EntryPoint",
    ...
    },
    {
      ...
      description:
        "India's most trusted debt settlement partner. We help you negotiate and settle credit card dues, personal loans, and more at up to 70% less than the original amount.",
      url: SITE_URL,
      logo: {
        "@type": "ImageObject",
        ...
        itemListElement: [
          {
            ...
            itemOffered: {
              ...
              description:
                "Negotiate and settle credit card outstanding dues at up to 70% less than the outstanding amount.",
            },
          },
          {
            "@type": "Offer",
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Debt settlement is a legal process where we negotiate with your lenders to reduce the total amount you owe. Instead of paying the full outstanding balance (including inflated interest and penalties), you pay a mutually agreed-upon lump sum that is significantly lower — often 30-70% less than the original amount.",
          },
        },
        {
          "@type": "Question",
