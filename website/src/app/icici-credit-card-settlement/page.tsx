...
export const metadata: Metadata = {
  ...
  title: "ICICI Credit Card Settlement | Settle at 40-75% Less | Due Dost",
  description:
    "Settle your ICICI Bank credit card outstanding dues at 40-75% less. Expert negotiation with ICICI collections. RBI compliant. Free consultation. Call +91 92894 93265.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Settle your ICICI Bank credit card outstanding dues at 40-75% less. Expert negotiation. Free consultation.",
  ...
  "@graph": [
    {
      ...
      description:
        "Expert ICICI credit card settlement service. Negotiate outstanding dues at 40-75% less.",
      ...
      <section className="py-20 md:py-28 bg-gradient-to-b from-blue-50/50 to-background dark:from-blue-950/20">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-10">
            Struggling with ICICI credit card outstanding? Our expert legal team has helped 1,000+ clients
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
            ...
            <a
              href="https://wa.me/919289493265?text=Hi%2C%20I%20want%20to%20settle%20my%20ICICI%20credit%20card%20debt.%20Please%20help."
              target="_blank"
      ...
      <section className="py-14 bg-muted/30">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <p className="mt-2 mb-8 text-muted-foreground">
            We negotiate settlements with all major Indian banks and NBFCs — not just ICICI.
          </p>
