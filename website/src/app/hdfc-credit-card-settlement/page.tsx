...
export const metadata: Metadata = {
  ...
  description:
    "Settle your HDFC Bank credit card outstanding dues at 40-75% less. Expert negotiation with HDFC collections team. RBI compliant. Free consultation. Call +91 92894 93265.",
  keywords: [
      ...
      <section className="py-20 md:py-28 bg-gradient-to-b from-blue-50/50 to-background dark:from-blue-950/20">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
            ...
            <a
              href="https://wa.me/919289493265?text=Hi%2C%20I%20want%20to%20settle%20my%20HDFC%20credit%20card%20debt.%20Please%20help."
              target="_blank"
