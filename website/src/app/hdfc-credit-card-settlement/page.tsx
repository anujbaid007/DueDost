...
export const metadata: Metadata = {
  ...
  title: "HDFC Credit Card Settlement | Settle at 40-70% Less | Due Dost",
  description:
    "Settle your HDFC Bank credit card outstanding dues at 40-70% less. Expert negotiation with HDFC collections team. RBI compliant. Free consultation. Call +91 96014 43663.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Settle your HDFC Bank credit card outstanding dues at 40-70% less. Expert negotiation. Free consultation.",
  ...
  "@graph": [
    {
      ...
      description:
        "Expert HDFC credit card settlement service. Negotiate outstanding dues at 40-70% less.",
      ...
      <section className="py-20 md:py-28 bg-gradient-to-b from-blue-50/50 to-background dark:from-blue-950/20">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-10">
            Struggling with HDFC credit card outstanding? Our expert legal team has helped thousands
