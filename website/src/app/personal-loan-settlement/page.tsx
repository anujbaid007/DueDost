...
export const metadata: Metadata = {
  ...
  description:
    "Settle your personal loan at up to 60% less than the outstanding amount. Expert legal team negotiates directly with banks and NBFCs. RBI compliant. Free consultation. Call +91 96014 43663.",
  keywords: [
        ...
        <section className="py-20 md:py-32 bg-gradient-to-b from-blue-50/50 to-background dark:from-blue-950/20">
          <div className="max-w-6xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <a
                href="https://wa.me/919601443663?text=Hi%2C%20I%20want%20to%20settle%20my%20personal%20loan.%20Please%20help."
                target="_blank"
